  ...
  if (items.length === 0) {
    return (
      <div className="mx-auto max-w-[1200px] px-6 py-20 text-center">
        ...
        <h1 className="mt-4 text-xl font-black uppercase tracking-wider text-foreground">Cart is Empty</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Explore the catalog and add some gear.
        </p>
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-6 py-12">
      <div className="mb-8 flex items-center gap-3">
        ...
        <h1 className="text-lg font-black uppercase tracking-wider text-foreground">Shopping Cart</h1>
      </div>
        ...
        <Card className="h-fit border-border bg-card">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-mono text-foreground">{subtotal >= 99 ? "Free" : "$9.99"}</span>
            </div>
