...
## Admin Frontend (internal)

This repo also includes a Next.js admin frontend used for demos and internal testing.

- `admin-frontend/README.md` – Setup and features
- `admin-frontend/CRM_API.md` – CRM endpoint contract
- `admin-frontend/CRM_SMOKE_TEST.md` – Manual QA checklist
