...
export default function BannersPage() {
  ...
  const saveEdit = async (id: string) => {
    ...
    try {
      ...
      setBanners((list) =>
        list.map((b) => (b.id === id ? { ...b, ...editForm } : b)),
      );
      setEditId(null);
    } catch {
      ...
      <div className="mb-8">
        ...
        <div className="border rounded p-4 flex flex-col items-center bg-gray-50">
          ...
          <div className="text-xs text-gray-500 mt-2">
            {form.startDate && `Início: ${form.startDate}`}{" "}
            {form.endDate && `| Fim: ${form.endDate}`}
          </div>
        </div>
      </div>
            ...
            >
                ...
                {editId === banner.id ? (
                  ...
                  <>
                    ...
                    <div className="text-xs text-gray-400">
                      {banner.active ? "Ativo" : "Desativado"}
                    </div>
                    {banner.link && (
                    ...
                    <div className="text-xs text-gray-500 mt-1">
                      {banner.startDate && `Início: ${banner.startDate}`}{" "}
                      {banner.endDate && `| Fim: ${banner.endDate}`}
                    </div>
                    {banner.image && (
                      <Image
                        src={banner.image}
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={ordering || idx === banners.length - 1}
                >
                  ↓
                </button>
              </div>
