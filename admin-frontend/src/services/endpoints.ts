...
export const endpoints = {
  ...
  admin: {
    ...
    crmCompanies: `${API_URL}/admin/crm/companies`,
    crmCompanyRename: `${API_URL}/admin/crm/companies/rename`,
    crmProposals: `${API_URL}/admin/crm/proposals`,
    crmProposalDetail: (id: string) => `${API_URL}/admin/crm/proposals/${id}`,
