...
export default function LgpdPanel() {
  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-2">Gerencie seus dados conforme a Lei Geral de Proteção de Dados.</div>
      <div className="flex gap-4 mb-4">
        <button onClick={handleExport} disabled={exporting} className="bg-blue-500 text-white px-4 py-2 rounded">
          {exporting ? 'Exportando...' : 'Exportar Dados'}
        </button>
        <button onClick={handleAnonymize} disabled={anonymizing} className="bg-red-500 text-white px-4 py-2 rounded">
